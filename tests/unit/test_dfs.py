from algorithms.binary_tree.dfs import traverse_depth_first_search_in_order, traverse_depth_first_search_post_order, traverse_depth_first_search_pre_order


def test_traverse_depth_first_search_pre_order(
...
def test_traverse_depth_first_search_in_order(
    with_one_to_seven_tree, with_tracker
):
